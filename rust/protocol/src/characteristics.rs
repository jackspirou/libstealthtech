...
pub const SERVICE_GENERIC_ACCESS: Uuid =
    Uuid::from_bytes([0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5f, 0x9b, 0x34, 0xfb]);

/// Generic Attribute Service (0x1801).
pub const SERVICE_GENERIC_ATTRIBUTE: Uuid =
    Uuid::from_bytes([0x00, 0x00, 0x18, 0x01, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5f, 0x9b, 0x34, 0xfb]);

/// Device Information Service (0x180A).
pub const SERVICE_DEVICE_INFORMATION: Uuid =
    Uuid::from_bytes([0x00, 0x00, 0x18, 0x0A, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x5f, 0x9b, 0x34, 0xfb]);
